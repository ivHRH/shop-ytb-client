      ...
      <div className={`container ${styles.dashboard__container}`}>
        ...
        <div className={styles.dashboard__about}>
          ...
          <p className={`${styles.dashboard__about__text} ${darkModeClass}`}>
            ...
            котла в будь якій точці України: Здійснюємо доставку запчастини до
            газових котлів до наступних міст: Київ, Житомир, Черкаси, Чернігів,
            Львів, Одесса, Тернопіль, Івано-Франківськ, Суми, Вінниця, Дніпро,
            Миколаїв, Буча, Коломия, Рівне, Чернівці, Ужгород, Луцьк, Харків
          </p>
        </div>
      </div>
    </section>
